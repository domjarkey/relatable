...
For more detailed information, see the `relatable` help documentation [online](https://cran.r-project.org/web/packages/relatable/relatable.pdf) or with `?relate` in R, as well as the [Relation Types and Restrictions](https://cran.r-project.org/web/packages/relatable/vignettes/restrictions.html) vignette (`vignette("restrictions")` in R).
